...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(final AuthenticationManagerBuilder auth) throws Exception {
    ...
    if (this.isH2DataSource()) {
      ...
      this.userService.deleteUser("yrd-todomvc-app", Security.USER_USER, FALSE);
      this.userService.createUser("yrd-todomvc-app", Security.USER_USER, password);

      this.userService.deleteUser("yrd-todomvc-thymeleaf", Security.USER_USER, FALSE);
      this.userService.createUser("yrd-todomvc-thymeleaf", Security.USER_USER, password);

      this.userService.deleteUser("yrd-todomvc-gateway", Security.USER_USER, FALSE);
      this.userService.createUser("yrd-todomvc-gateway", Security.USER_USER, password);
    }
  }
