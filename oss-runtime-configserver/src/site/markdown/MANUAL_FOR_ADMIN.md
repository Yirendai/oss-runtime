...
+ 确保应用名称未被使用
    ...
    > - 应用应具备相应的域名
    > - 开发/测试环境为 `${spring.application.name}.yixinonline.org`
    > - 生成环境为 `${spring.application.name}.yrd.idc`
+ 为应用生成一个随机密码
    > - 方法为 TODO
+ 为应用创建用户
    > - 方法为 TODO
...
TODO fixme
    ...
    GIT_PREFIX="http://gitlab.yixinonline.org/configserver";
